...
Wait(myJobMuDP[[1]], minWait, maxWait)
Wait(myJobMuDF[[1]], minWait, maxWait)
Wait(myJobMuDPP[[1]], minWait, maxWait)
Wait(myJobMuDPS[[1]], minWait, maxWait)
Wait(myJobMuDC[[1]], minWait, maxWait)
Wait(myJobMuDM[[1]], minWait, maxWait)
Wait(myJobMuPP[[1]], minWait, maxWait)
Wait(myJobMuPF[[1]], minWait, maxWait)
Wait(myJobMuPPP[[1]], minWait, maxWait)
Wait(myJobMuPPS[[1]], minWait, maxWait)
Wait(myJobMuPC[[1]], minWait, maxWait)
Wait(myJobMuPM[[1]], minWait, maxWait)
Wait(myJobMaDF[[1]], minWait, maxWait)
Wait(myJobMaDC[[1]], minWait, maxWait)
Wait(myJobMaPF[[1]], minWait, maxWait)
Wait(myJobMaPC[[1]], minWait, maxWait)
Wait(myJobCWDP[[1]], minWait, maxWait)
Wait(myJobCWDC[[1]], minWait, maxWait)
Wait(myJobCWDN[[1]], minWait, maxWait)
Wait(myJobCWDGCG[[1]], minWait, maxWait)
Wait(myJobCWDGDE[[1]], minWait, maxWait)
Wait(myJobCWDPIR[[1]], minWait, maxWait)
Wait(myJobCWPP[[1]], minWait, maxWait)
Wait(myJobCWPC[[1]], minWait, maxWait)
Wait(myJobCWPN[[1]], minWait, maxWait)
Wait(myJobCWPGCG[[1]], minWait, maxWait)
Wait(myJobCWPGDE[[1]], minWait, maxWait)
Wait(myJobCWPPIR[[1]], minWait, maxWait)
@
...
Wait(myJobFaDMuP[[1]], minWait, maxWait)
Wait(myJobFaDCWP[[1]], minWait, maxWait)
Wait(myJobFaDMuF[[1]], minWait, maxWait)
Wait(myJobFaDCWF[[1]], minWait, maxWait)
Wait(myJobFaPMuP[[1]], minWait, maxWait)
Wait(myJobFaPCWP[[1]], minWait, maxWait)
Wait(myJobFaPMuF[[1]], minWait, maxWait)
Wait(myJobFaPCWF[[1]], minWait, maxWait)
Wait(myJobRDMuP[[1]], minWait, maxWait)
Wait(myJobRDCWP[[1]], minWait, maxWait)
Wait(myJobRDMuP[[1]], minWait, maxWait)
Wait(myJobRDCWP[[1]], minWait, maxWait)
Wait(myJobRPMuP[[1]], minWait, maxWait)
Wait(myJobRPCWP[[1]], minWait, maxWait)
Wait(myJobPDMuPP[[1]], minWait, maxWait)
Wait(myJobPPMuPP[[1]], minWait, maxWait)
Wait(myJobCWPPIR[[1]], minWait, maxWait)
@

<<RetrieveJobs, results=HIDE, echo=FALSE>>=
RetrieveJob(myJobMuDP[[1]], c("phylip_interleaved.aln"))
RetrieveJob(myJobMuDF[[1]], c("fasta.aln"))
RetrieveJob(myJobMuDPP[[1]], c("phylip_pars.aln"))
RetrieveJob(myJobMuDPS[[1]], c("phylip_sequential.aln"))
RetrieveJob(myJobMuDC[[1]], c("clustalw.aln"))
RetrieveJob(myJobMuDM[[1]], c("msf.aln"))
RetrieveJob(myJobMuPP[[1]], c("phylip_interleaved.aln"))
RetrieveJob(myJobMuPF[[1]], c("fasta.aln"))
RetrieveJob(myJobMuPPP[[1]], c("phylip_pars.aln"))
RetrieveJob(myJobMuPPS[[1]], c("phylip_sequential.aln"))
RetrieveJob(myJobMuPC[[1]], c("clustalw.aln"))
RetrieveJob(myJobMuPM[[1]], c("msf.aln"))
RetrieveJob(myJobMaDF[[1]], c("mafft.fa"))
RetrieveJob(myJobMaDC[[1]], c("mafft.fa"))
RetrieveJob(myJobMaPF[[1]], c("mafft.fa"))
RetrieveJob(myJobMaPC[[1]], c("mafft.fa"))
RetrieveJob(myJobCWDP[[1]], c("clustalw2.fa"))
RetrieveJob(myJobCWDC[[1]], c("clustalw2.fa"))
RetrieveJob(myJobCWDN[[1]], c("clustalw2.fa"))
RetrieveJob(myJobCWDGCG[[1]], c("clustalw2.fa"))
RetrieveJob(myJobCWDGDE[[1]], c("clustalw2.fa"))
RetrieveJob(myJobCWDPIR[[1]], c("clustalw2.fa"))
RetrieveJob(myJobCWPP[[1]], c("clustalw2.fa"))
RetrieveJob(myJobCWPC[[1]], c("clustalw2.fa"))
RetrieveJob(myJobCWPN[[1]], c("clustalw2.fa"))
RetrieveJob(myJobCWPGCG[[1]], c("clustalw2.fa"))
RetrieveJob(myJobCWPGDE[[1]], c("clustalw2.fa"))
RetrieveJob(myJobCWPPIR[[1]], c("clustalw2.fa"))
RetrieveJob(myJobFaDMuP[[1]], c("fasttree.nwk"))
RetrieveJob(myJobFaDCWP[[1]], c("fasttree.nwk"))
RetrieveJob(myJobFaDMuF[[1]], c("fasttree.nwk"))
RetrieveJob(myJobFaDCWF[[1]], c("fasttree.nwk"))
RetrieveJob(myJobFaPMuP[[1]], c("fasttree.nwk"))
RetrieveJob(myJobFaPCWP[[1]], c("fasttree.nwk"))
RetrieveJob(myJobFaPMuF[[1]], c("fasttree.nwk"))
RetrieveJob(myJobFaPCWF[[1]], c("fasttree.nwk"))
RetrieveJob(myJobRDMuP[[1]], c("RAxML_bestTree.nwk"))
RetrieveJob(myJobRDCWP[[1]], c("RAxML_bestTree.nwk"))
RetrieveJob(myJobRPMuP[[1]], c("RAxML_bestTree.nwk"))
RetrieveJob(myJobRPCWP[[1]], c("RAxML_bestTree.nwk"))
RetrieveJob(myJobPDMuPP[[1]], c("outtree.nwk"))
RetrieveJob(myJobPPMuPP[[1]], c("outtree.nwk"))
@
...
data(geno_test.tfam)
write(t(as.matrix(geno_test.tfam)), file="geno_test.tfam", ncolumns=length(geno_test.tfam), sep="\t")
UploadFile(local.file.name="geno_test.tfam")

data(geno_test.tped)
write(t(as.matrix(geno_test.tped)), file="geno_test.tped", ncolumns=length(geno_test.tped), sep="\t")
...
Wait(myJobPLINKCT[[1]], minWait, maxWait)
@
